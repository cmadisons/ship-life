...
Kept, not thrown away. Four lists of twenty-five: things to add, things to
take away, things to change, and things to make better. Cross one off when it
is built rather than deleting it, and add to it whenever something comes up.

What is **not** on here, because it is already decided and built: what a friend
does (they give you gear — Ben the armour and the bombs, Izzy the boots and the
rest of the set), and what floor 16 is (the friends' room, Izzy's).
...
~~Pac-Man could have ghosts with personalities~~ **built**: already were — Blinky chases, Pinky cuts ahead, Inky works off Blinky, Clyde loses his nerve inside eight squares
...
6. ~~The fridge could hold more as the ship grows~~ **built**: 5, then 9 at floor 11, then 27 once you own the lot
...
12. ~~The gas could stain the floor while it lasts~~ **built**: its edge drawn on the floor, so you can see what you are standing in
...
17. ~~Quest Day could pick harder quests as you get better~~ **built**: +1% a set, to double at 100
